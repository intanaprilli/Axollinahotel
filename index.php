    ...
    <nav class="main-header navbar navbar-expand-md navbar-dark navbar-black">
      <div class="container">
        <a href="assets/index3.html" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light">Axollina hotel</span>
        </a>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Hotel Axollina</h1>
            </div>
            <div class="col-sm-6">
              <!-- <ol class="breadcrumb float-sm-right">
              <button type="button" class="form-control btn btn-primary" data-toggle="modal" data-target="#pesan" >Booking</button>
              </ol> -->
            <!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                  ...
                  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="assets/gambar/home01.jpg" alt="First slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/home02.jpg" alt="Second slide" height="450">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="assets/gambar/home03.jpg" alt="Third slide" height="450">
                      </div>
                    </div>
                ...
                <div class="card-body">
                  <div class="row">                   
                    <div class="col-sm-2 mx-auto">
                      <button type="button" class="form-control btn btn-primary" data-toggle="modal" data-target="#pesan">Pesan Sekarang</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card">
              <div class="col-md-12">
                <div class="card-body">
                  ...
                  <p class="text-center">Selamat Datang Di Axollina Hotel .Hotel Axollina merupkan sebuah hotel  yang terletak di pusat kota Bali 
Hotel Axollina merupakan Hotel  dengan bangunan yang tergolong masih baru dan dengan fasilisas yang tentunya akan membuat nyaman anda selama menginap di hotel Axollina</p>
                </div>
              </div>
            </div>          
          </div><!-- /.container-fluid -->
